...
![download](https://user-images.githubusercontent.com/125905968/226272639-6b1f8497-500c-4639-bff1-a1299785c386.png)
	...
	พบว่า S&P500 และSET50 ให้อัตราผลตอบแทนรายปีไปในทิศทางเดียวกัน แต่เมื่อเทียบเป็นเปอร์เซนต์(%) แล้ว S&P500 ให้อัตราผลตอบแทนมากกว่าทั้งบวกและลบ แสดงว่า S&P500 มีความผันผวนสูงกว่า SET50 
	ดังนั้นผู้ที่ต้องการจะลงทุนควรศึกษา
